# # Load the MediaPipe image classification model.
...
# STEP 1: Import the necessary modules. 추론 모델 가져오기
import mediapipe as mp
from mediapipe.tasks import python
from mediapipe.tasks.python.components import processors
from mediapipe.tasks.python import vision

# STEP 2: Create an ImageClassifier object. 추론 모델 생성
...
classification_result = classifier.classify(image) # forward(), inference()와 같은 역할
